...
public class ItemCustomHoe extends ItemHoe
{
    ...
    public ItemCustomHoe(ToolMaterial material) {
        ...
        setUnlocalizedName(Reference.MOD_ID + "." + Reference.ItemBase.MODHOE.getUnlocalizedName() + "_" + getMaterialName().toLowerCase());
        setRegistryName(Reference.ItemBase.MODHOE.getRegistryName()  + "_" + getMaterialName().toLowerCase());
    }
